...
Git git-scm.com - розподілена система контролю версій;

GitHub github.com - хмарна платформа для хостингу Git репозиторіїв;

Visual Studio Code code.visualstudio.com - редактор коду з підтримкою Git;

GitHub Desktop desktop.github.com - графічний клієнт Git (опціонально).
...
Додавання змін до індексу командою git add;

Створення коміту командою git commit;

Відправлення змін на віддалений сервер командою git push.
...
Типи комітів: - feat — нова функціональність; - fix — виправлення помилки; - docs — зміни в документації; - style — зміни в форматуванні коду; - refactor — рефакторинг коду; - test — додавання або зміна тестів; - chore — технічні зміни.
...
сформувати команду з 3-4 осіб;

обрати тему спільного проєкту;

визначити ролі учасників команди (team lead, developer, QA).

Планування проєкту:

створити список основних функцій додатка;

розподілити завдання між учасниками команди;

визначити технологічний стек проєкту.

Індивідуальне налаштування Git

завантажити та встановити Git з офіційного сайту;

перевірити встановлення командою git --version;
...
зареєструватися на github.com;

Створення спільного репозиторію/



створити новий репозиторій на GitHub (виконує team lead);

налаштувати базову структуру проєкту;

створити файл README.md з описом проєкту;

створити початковий коміт та відправити на GitHub;

додати всіх учасників команди як collaborators.
...
створити Pull Request для кожної завершеної функції;

призначити reviewers з команди;

обговорити зміни та внести правки при необхідності;

злити PR після схвалення команди.

Вирішення конфліктів

Типові сценарії конфліктів:

одночасне редагування одного файлу;

видалення файлу одним розробником та редагування іншим;

конфлікти при злитті довготривалих гілок.
...
Документування та презентація

оновити README.md з детальним описом проєкту;

додати інструкції з встановлення та запуску;

додати CHANGELOG.md з історією змін;

створити і додати lab02-report.md для кожного учасника команди відповідно до шаблону звіту ( завантажити шаблон);
